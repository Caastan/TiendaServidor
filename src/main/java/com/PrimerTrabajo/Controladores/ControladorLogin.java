...
public class ControladorLogin {
    ...
    public ModelAndView index(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	/*Condicion para que no se dejen vacios los campos de iniciar sesion.
    	  Si se dejan vacios redirige al index si no pasa a primera donde se valida.
    	*/
    ...
    @GetMapping("/primera")
    public ModelAndView primera(HttpServletRequest request,HttpServletResponse response) throws ServletException, IOException{
    	...
    	if(usuario != null && usuario.size() != 0) {
    		...
    		}else { mw = new ModelAndView ("primeraadmin");}
    ...
    @GetMapping("/carrito")
    public ModelAndView carrito(HttpServletRequest request,HttpServletResponse response) throws ServletException, IOException{
    	HttpSession sesion = request.getSession();
    	//Condicion que se ponen en todos para que no se puedan acceder a ellas sin antes tener la sesion validada.
    ...
    @GetMapping("/ventas")
    public ModelAndView ventas(HttpServletRequest request,HttpServletResponse response) throws ServletException, IOException{
    	HttpSession sesion = request.getSession();
    ...
    public ModelAndView producto1(HttpServletRequest request,HttpServletResponse response) throws ServletException, IOException{
    	HttpSession sesion = request.getSession();
    ...
    public ModelAndView producto2(HttpServletRequest request,HttpServletResponse response) throws ServletException, IOException{
    	HttpSession sesion = request.getSession();
    ...
    public ModelAndView producto3(HttpServletRequest request,HttpServletResponse response) throws ServletException, IOException{
    	HttpSession sesion = request.getSession();
    ...
    public ModelAndView producto4(HttpServletRequest request,HttpServletResponse response) throws ServletException, IOException{
    	HttpSession sesion = request.getSession();
    	ModelAndView mw = new ModelAndView ("producto3");
    	int idVenta = 4;
    ...
    @GetMapping("/producto")
    public ModelAndView producto(HttpServletRequest request,HttpServletResponse response) throws ServletException, IOException{
    	HttpSession sesion = request.getSession();
    	ModelAndView mw = new ModelAndView ("producto1");
    	if (sesion.getAttribute("login") == null) {
	  		response.sendRedirect("index");
